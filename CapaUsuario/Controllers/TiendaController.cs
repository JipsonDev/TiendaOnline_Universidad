...
namespace CapaPresentacionTienda.Controllers
{
    public class TiendaController : Controller
    {
        ...
        [HttpPost]
        public JsonResult ObtenerParroquia(string IdProvincia, string IdCanton)
        {
            List<Parroquia> oLista = new List<Parroquia>();

            oLista = new CN_Ubicacion().ObtenerParroquia(IdProvincia, IdCanton);
            return Json(new { lista = oLista }, JsonRequestBehavior.AllowGet);
        }
        [ValidarSession]
        [Authorize]
        ...
        public async Task<JsonResult> ProcesarPago(List<Carrito> oListaCarrito, Venta oVenta)
        {
            ...
            detalle_venta.Locale = new CultureInfo("es-EC");
